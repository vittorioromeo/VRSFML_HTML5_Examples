...
function findWasmBinary() {
  return locateFile("arkanoid.wasm");
}
...
var ASM_CONSTS = {
  ...
  391434: () => Module["SDL3"]["mouse_x"],
  391472: () => Module["SDL3"]["mouse_y"],
  391510: $0 => Module["SDL3"]["mouse_buttons"][$0],
  391558: $0 => {
    var data = $0;
  ...
  393802: () => document.body.clientWidth,
  393840: () => document.body.clientHeight,
  393879: () => window.innerWidth,
  393909: () => window.innerHeight,
  393940: () => window.outerWidth,
  393970: () => window.outerHeight,
  394001: () => window.pageXOffset,
  394032: () => window.pageYOffset,
  394063: ($0, $1) => {
  ...
  400341: () => window.innerWidth,
  400371: () => window.innerHeight,
  400402: $0 => {
  ...
  402874: () => window.innerWidth,
  402904: () => window.innerHeight,
  402935: $0 => {
