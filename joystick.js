...
var ASM_CONSTS = {
  ...
  503486: () => Module["SDL3"]["mouse_x"],
  503524: () => Module["SDL3"]["mouse_y"],
  503562: $0 => Module["SDL3"]["mouse_buttons"][$0],
  503610: $0 => {
    var data = $0;
  ...
  505854: () => document.body.clientWidth,
  505892: () => document.body.clientHeight,
  505931: () => window.innerWidth,
  505961: () => window.innerHeight,
  505992: () => window.outerWidth,
  506022: () => window.outerHeight,
  506053: () => window.pageXOffset,
  506084: () => window.pageYOffset,
  506115: ($0, $1) => {
  ...
  512393: () => window.innerWidth,
  512423: () => window.innerHeight,
  512454: $0 => {
  ...
  514926: () => window.innerWidth,
  514956: () => window.innerHeight,
  514987: $0 => {
