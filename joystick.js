...
function findWasmBinary() {
  return locateFile("joystick.wasm");
}
...
var ASM_CONSTS = {
  ...
  503087: () => Module["SDL3"]["mouse_x"],
  503125: () => Module["SDL3"]["mouse_y"],
  503163: $0 => Module["SDL3"]["mouse_buttons"][$0],
  503211: $0 => {
    var data = $0;
  ...
  505455: () => document.body.clientWidth,
  505493: () => document.body.clientHeight,
  505532: () => window.innerWidth,
  505562: () => window.innerHeight,
  505593: () => window.outerWidth,
  505623: () => window.outerHeight,
  505654: () => window.pageXOffset,
  505685: () => window.pageYOffset,
  505716: ($0, $1) => {
  ...
  511994: () => window.innerWidth,
  512024: () => window.innerHeight,
  512055: $0 => {
  ...
  514521: () => window.innerWidth,
  514551: () => window.innerHeight,
  514582: $0 => {
