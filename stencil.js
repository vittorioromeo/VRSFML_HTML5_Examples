...
function findWasmBinary() {
  return locateFile("stencil.wasm");
}
...
var ASM_CONSTS = {
  ...
  370347: () => Module["SDL3"]["mouse_x"],
  370385: () => Module["SDL3"]["mouse_y"],
  370423: $0 => Module["SDL3"]["mouse_buttons"][$0],
  370471: $0 => {
    var data = $0;
  ...
  372715: () => document.body.clientWidth,
  372753: () => document.body.clientHeight,
  372792: () => window.innerWidth,
  372822: () => window.innerHeight,
  372853: () => window.outerWidth,
  372883: () => window.outerHeight,
  372914: () => window.pageXOffset,
  372945: () => window.pageYOffset,
  372976: ($0, $1) => {
  ...
  379254: () => window.innerWidth,
  379284: () => window.innerHeight,
  379315: $0 => {
  ...
  381781: () => window.innerWidth,
  381811: () => window.innerHeight,
  381842: $0 => {
