...
// include: /usr/lib/emscripten/src/emrun_prejs.js
/**
 * @license
...
// end include: /usr/lib/emscripten/src/emrun_prejs.js
var arguments_ = [];
...
function findWasmBinary() {
  return locateFile("rockets.wasm");
}
...
function _eglSwapBuffers(dpy, surface) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(21, 0, 1, dpy, surface);
...
function _emscripten_get_gamepad_status(index, gamepadState) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(29, 0, 1, index, gamepadState);
...
function _emscripten_get_screen_size(width, height) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(31, 0, 1, width, height);
            ...
            if (defs.hasOwnProperty(symbol)) {
              ...
              if (typeof pp == "function") {
                ...
                if (pp.length) {
                  ...
                  // A zero-arg function macro (#define FOO() BAR)?
                  expanded = pp();
                }
              } else {
                // Definition is either a boolean, an integer or a string.. in any case, not a macro.
...
function _emscripten_request_fullscreen_strategy(target, deferUntilInEventHandler, fullscreenStrategy) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(32, 0, 1, target, deferUntilInEventHandler, fullscreenStrategy);
  var strategy = {
...
function _emscripten_request_pointerlock(target, deferUntilInEventHandler) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(33, 0, 1, target, deferUntilInEventHandler);
  target = findEventTarget(target);
  if (!target) return -4;
  if (!target.requestPointerLock) {
    return -1;
...
function _emscripten_set_beforeunload_callback_on_thread(userData, callbackfunc, targetThread) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(35, 0, 1, userData, callbackfunc, targetThread);
...
var registerOrientationChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
  ...
  var orientationChangeEventHandlerFunc = e => {
    ...
    if (targetThread) __emscripten_run_callback_on_thread(targetThread, callbackfunc, eventTypeId, orientationChangeEvent, eventSize, userData); else if (((a1, a2, a3) => dynCall_iiii(callbackfunc, a1, a2, a3))(eventTypeId, orientationChangeEvent, userData)) e.preventDefault();
  };
  var eventHandler = {
    target,
    eventTypeString,
...
var ASM_CONSTS = {
  ...
  890886: () => Module["SDL3"]["mouse_x"],
  890924: () => Module["SDL3"]["mouse_y"],
  890962: $0 => Module["SDL3"]["mouse_buttons"][$0],
  891010: $0 => {
    var data = $0;
  ...
  893254: () => document.body.clientWidth,
  893292: () => document.body.clientHeight,
  893331: () => window.innerWidth,
  893361: () => window.innerHeight,
  893392: () => window.outerWidth,
  893422: () => window.outerHeight,
  893453: () => window.pageXOffset,
  893484: () => window.pageYOffset,
  893515: ($0, $1) => {
  ...
  899793: () => window.innerWidth,
  899823: () => window.innerHeight,
  899854: $0 => {
  ...
  902326: () => window.innerWidth,
  902356: () => window.innerHeight,
  902387: $0 => {
...
// include: /usr/lib/emscripten/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
