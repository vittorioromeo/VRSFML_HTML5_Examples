...
var ASM_CONSTS = {
  ...
  505807: () => Module["SDL3"]["mouse_x"],
  505845: () => Module["SDL3"]["mouse_y"],
  505883: $0 => Module["SDL3"]["mouse_buttons"][$0],
  505931: $0 => {
    var data = $0;
  ...
  508175: () => document.body.clientWidth,
  508213: () => document.body.clientHeight,
  508252: () => window.innerWidth,
  508282: () => window.innerHeight,
  508313: () => window.outerWidth,
  508343: () => window.outerHeight,
  508374: () => window.pageXOffset,
  508405: () => window.pageYOffset,
  508436: ($0, $1) => {
  ...
  514714: () => window.innerWidth,
  514744: () => window.innerHeight,
  514775: $0 => {
  ...
  517241: () => window.innerWidth,
  517271: () => window.innerHeight,
  517302: $0 => {
