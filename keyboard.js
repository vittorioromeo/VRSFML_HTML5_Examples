...
function findWasmBinary() {
  return locateFile("keyboard.wasm");
}
...
var ASM_CONSTS = {
  ...
  2359822: () => Module["SDL3"]["mouse_x"],
  2359860: () => Module["SDL3"]["mouse_y"],
  2359898: $0 => Module["SDL3"]["mouse_buttons"][$0],
  2359946: $0 => {
    var data = $0;
  ...
  2362190: () => document.body.clientWidth,
  2362228: () => document.body.clientHeight,
  2362267: () => window.innerWidth,
  2362297: () => window.innerHeight,
  2362328: () => window.outerWidth,
  2362358: () => window.outerHeight,
  2362389: () => window.pageXOffset,
  2362420: () => window.pageYOffset,
  2362451: ($0, $1) => {
  ...
  2368729: () => window.innerWidth,
  2368759: () => window.innerHeight,
  2368790: $0 => {
  ...
  2371262: () => window.innerWidth,
  2371292: () => window.innerHeight,
  2371323: $0 => {
  ...
  2377311: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  2377415: () => {
    try {
  ...
  2380463: $0 => window.miniaudio.get_device_by_index($0).webaudio.sampleRate,
  2380536: $0 => {
