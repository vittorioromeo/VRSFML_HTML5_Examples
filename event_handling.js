...
function findWasmBinary() {
  return locateFile("event_handling.wasm");
}
...
var ASM_CONSTS = {
  ...
  2079918: () => Module["SDL3"]["mouse_x"],
  2079956: () => Module["SDL3"]["mouse_y"],
  2079994: $0 => Module["SDL3"]["mouse_buttons"][$0],
  2080042: $0 => {
    var data = $0;
  ...
  2082286: () => document.body.clientWidth,
  2082324: () => document.body.clientHeight,
  2082363: () => window.innerWidth,
  2082393: () => window.innerHeight,
  2082424: () => window.outerWidth,
  2082454: () => window.outerHeight,
  2082485: () => window.pageXOffset,
  2082516: () => window.pageYOffset,
  2082547: ($0, $1) => {
  ...
  2088825: () => window.innerWidth,
  2088855: () => window.innerHeight,
  2088886: $0 => {
  ...
  2091358: () => window.innerWidth,
  2091388: () => window.innerHeight,
  2091419: $0 => {
