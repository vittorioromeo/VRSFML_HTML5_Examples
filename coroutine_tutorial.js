...
var ASM_CONSTS = {
  ...
  503327: () => Module["SDL3"]["mouse_x"],
  503365: () => Module["SDL3"]["mouse_y"],
  503403: $0 => Module["SDL3"]["mouse_buttons"][$0],
  503451: $0 => {
    var data = $0;
  ...
  505695: () => document.body.clientWidth,
  505733: () => document.body.clientHeight,
  505772: () => window.innerWidth,
  505802: () => window.innerHeight,
  505833: () => window.outerWidth,
  505863: () => window.outerHeight,
  505894: () => window.pageXOffset,
  505925: () => window.pageYOffset,
  505956: ($0, $1) => {
  ...
  512234: () => window.innerWidth,
  512264: () => window.innerHeight,
  512295: $0 => {
  ...
  514761: () => window.innerWidth,
  514791: () => window.innerHeight,
  514822: $0 => {
