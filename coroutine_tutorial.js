...
function findWasmBinary() {
  return locateFile("coroutine_tutorial.wasm");
}
...
var ASM_CONSTS = {
  ...
  503343: () => Module["SDL3"]["mouse_x"],
  503381: () => Module["SDL3"]["mouse_y"],
  503419: $0 => Module["SDL3"]["mouse_buttons"][$0],
  503467: $0 => {
    var data = $0;
  ...
  505711: () => document.body.clientWidth,
  505749: () => document.body.clientHeight,
  505788: () => window.innerWidth,
  505818: () => window.innerHeight,
  505849: () => window.outerWidth,
  505879: () => window.outerHeight,
  505910: () => window.pageXOffset,
  505941: () => window.pageYOffset,
  505972: ($0, $1) => {
  ...
  512250: () => window.innerWidth,
  512280: () => window.innerHeight,
  512311: $0 => {
  ...
  514777: () => window.innerWidth,
  514807: () => window.innerHeight,
  514838: $0 => {
