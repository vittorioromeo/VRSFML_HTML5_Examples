...
var ASM_CONSTS = {
  ...
  742759: () => Module["SDL3"]["mouse_x"],
  742797: () => Module["SDL3"]["mouse_y"],
  742835: $0 => Module["SDL3"]["mouse_buttons"][$0],
  742883: $0 => {
    var data = $0;
  ...
  745127: () => document.body.clientWidth,
  745165: () => document.body.clientHeight,
  745204: () => window.innerWidth,
  745234: () => window.innerHeight,
  745265: () => window.outerWidth,
  745295: () => window.outerHeight,
  745326: () => window.pageXOffset,
  745357: () => window.pageYOffset,
  745388: ($0, $1) => {
  ...
  751666: () => window.innerWidth,
  751696: () => window.innerHeight,
  751727: $0 => {
  ...
  754193: () => window.innerWidth,
  754223: () => window.innerHeight,
  754254: $0 => {
