...
var ASM_CONSTS = {
  ...
  8333878: () => Module["SDL3"]["mouse_x"],
  8333916: () => Module["SDL3"]["mouse_y"],
  8333954: $0 => Module["SDL3"]["mouse_buttons"][$0],
  8334002: $0 => {
    var data = $0;
  ...
  8336246: () => document.body.clientWidth,
  8336284: () => document.body.clientHeight,
  8336323: () => window.innerWidth,
  8336353: () => window.innerHeight,
  8336384: () => window.outerWidth,
  8336414: () => window.outerHeight,
  8336445: () => window.pageXOffset,
  8336476: () => window.pageYOffset,
  8336507: ($0, $1) => {
  ...
  8342785: () => window.innerWidth,
  8342815: () => window.innerHeight,
  8342846: $0 => {
  ...
  8345318: () => window.innerWidth,
  8345348: () => window.innerHeight,
  8345379: $0 => {
  ...
  8351367: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  8351471: () => {
    try {
  ...
  8354519: $0 => window.miniaudio.get_device_by_index($0).webaudio.sampleRate,
  8354592: $0 => {
