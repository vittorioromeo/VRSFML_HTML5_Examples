...
var ASM_CONSTS = {
  ...
  3975815: () => Module["SDL3"]["mouse_x"],
  3975853: () => Module["SDL3"]["mouse_y"],
  3975891: $0 => Module["SDL3"]["mouse_buttons"][$0],
  3975939: $0 => {
    var data = $0;
  ...
  3978183: () => document.body.clientWidth,
  3978221: () => document.body.clientHeight,
  3978260: () => window.innerWidth,
  3978290: () => window.innerHeight,
  3978321: () => window.outerWidth,
  3978351: () => window.outerHeight,
  3978382: () => window.pageXOffset,
  3978413: () => window.pageYOffset,
  3978444: ($0, $1) => {
  ...
  3984722: () => window.innerWidth,
  3984752: () => window.innerHeight,
  3984783: $0 => {
  ...
  3987249: () => window.innerWidth,
  3987279: () => window.innerHeight,
  3987310: $0 => {
  ...
  3993298: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  3993402: () => {
    try {
  ...
  3996450: $0 => window.miniaudio.get_device_by_index($0).webaudio.sampleRate,
  3996523: $0 => {
